...
const APPS = [
  ...
  },
  {
    ...
    poster: 'app-videos/thumbnails/clinicos-thumb.jpg',
    videoTitle: 'ClinicOS — Clinic Operations Platform',
    badgeLabel: 'Clinic OS',
    title: 'ClinicOS',
    desc: 'A full clinic operations platform — manage patients, appointments, records, and billing in one clean system built for healthcare providers.',
    tags: ['React', 'Node.js', 'MySQL', 'SaaS'],
  },
  {
    heroName: 'InventoryOS',
    heroCat: 'Stock Management',
    videoSrc: 'app-videos/InventoryOS-Demo.mp4',
    poster: 'app-videos/thumbnails/inventoryos-thumb.jpg',
    videoTitle: 'InventoryOS — Smart Stock Management',
    badgeLabel: 'Inventory OS',
    title: 'InventoryOS',
    desc: 'Real-time stock tracking, low-stock alerts, and automated reorder ranking — built for businesses that need full visibility over their inventory.',
    tags: ['React', 'Node.js', 'MySQL', 'SaaS'],
  },
  {
    heroName: 'PayrollOS',
    heroCat: 'Payroll Management',
    videoSrc: 'app-videos/PayrollOS-Demo.mp4',
    poster: 'app-videos/thumbnails/payrollos-thumb.jpg',
    videoTitle: 'PayrollOS — Payroll Management System',
    badgeLabel: 'Payroll OS',
    title: 'PayrollOS',
    desc: 'Automated payroll processing, tax computation, and payslip generation — built to eliminate manual payroll work for growing businesses.',
    tags: ['React', 'Node.js', 'MySQL', 'SaaS'],
  },
];
